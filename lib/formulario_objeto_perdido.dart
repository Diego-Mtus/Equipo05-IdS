...
class FormularioObjetoPerdido extends StatefulWidget {
  const FormularioObjetoPerdido({super.key});

  @override
  State<FormularioObjetoPerdido> createState() =>
      _FormularioObjetoPerdidoState();
}

class _FormularioObjetoPerdidoState
    extends State<FormularioObjetoPerdido> {
  ...
  Future<void> _enviarFormulario() async {
    ...
    // Si hay imagen seleccionada, guardar los bytes en Hive con la id del reporte
